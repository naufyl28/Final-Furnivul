      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg p-8">
        ...
        <div className="flex flex-wrap justify-between p-3 px-8">
          ...
          <div className="checkout-container">
            <button
              type="button"
              className="text-white bg-green-500 hover-bg-blue-800 focus-ring-4 focus-outline-none focus-ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark-bg-blue-600 dark-hover-bg-blue-700 dark-focus-ring-blue-800"
              id="checkout-button"
            >
              <svg
